            ...
            <div className="container my-3 mt-6 ">
                ...
                <form className='my-3'>
                    <div className="mb-3">
                        ...
                        <input type="text" className="form-control" id="title" name='title' aria-describedby="emailHelp" value={note.title} onChange={handleChange} minLength={5} required aria-required />
                    </div>
                    <div className="mb-3">
                    ...
                    <div className="mb-3">
                        ...
                        <input type="text" className="form-control" id="tag" name='tag' value={note.tag} onChange={handleChange} minLength={3} required aria-required />
                    </div>
